...
const handleSubmit= async(e)=>{
  ...
  const txl=await instance.issue(cert_id,username,course,grade,issuedate);
      ...
      <form onSubmit={handleSubmit}>
        <div className="border-2 rounded px-20" >
          ...
          <select className="border-2 border-black" name="course" id="course" onChange={(e) => setCourse(e.target.value)}>
            ...
            <option>Ethereum FundameEthereumntals</option>
          </select>
        </div>
        ...
        <div className="p-2">
          ...
          <input type='date' className="border-2 border-black" id="issuedate" name="issuedate"onChange={(e) => setIssuedate(e.target.value)} required/>
        </div>
